...
def svm_model_new(text):
    sev_val=0.0
    df=pd.read_csv(r"C:\Users\kumar\OneDrive\Documents\Projects\Spamerly\UI\SpamerlyAPI\Model\SVM\SMSSpamCollection.csv",names=['Label','Text'])
